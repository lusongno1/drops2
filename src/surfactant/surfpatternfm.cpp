...
/// \author LNM RWTH Aachen: Song Lu
/// reaction-diffusion equation for tumor growth
...
void StrategyPatternFM (DROPS::MultiGridCL& mg, DROPS::AdapTriangCL& adap, DROPS::LevelsetP2CL& lset)
{
    using namespace DROPS;
...
//        }
        ...
        if (P.get<bool>( "SurfTransp.Exp.StationaryPDE"))
        {
            ...
            StrategyPatternFMDeformation(mg,adap,lset);
